                        ...
                        <div class="right_top_section">
                           ...
                           <ul class="login">
                              <li class="login-modal">
                                 <a href="user_login.php" class="login"><i class="fa fa-user"></i>Login</a>
                              </li>
                              <li>
                                 <div class="cart-option">
                                    <a href="signup.php"><i class="fa fa-shopping-cart"></i>Register</a>
                                 </div>
                              </li>
                           </ul>
                           <!-- end button section -->
            ...
            <div class="row">
               <div class="col-lg-9 col-sm-12 col-xs-12">
                  <div class="news-post-holder">
                     ...
                     <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="news-post-widget">
                           <img class="img-responsive" src="images/hockey.jpeg" alt="hockey">
                           <div class="news-post-detail">
                              <!-- <span class="date">20 march 2016</span> -->
                              <h2><a href="blog-detail.html">Free play to ground in anywhere</a></h2>
                              <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
                     ...
                     <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="news-post-widget">
                           <img class="img-responsive" src="images/football.jpg" alt="">
                           <div class="news-post-detail">
                              <!-- <span class="date">20 march 2016</span> -->
                              <h2><a href="blog-detail.html">Free play to ground in anywhere</a></h2>
                              <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
                     ...
                     <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="news-post-widget">
                           <img class="img-responsive" src="images/football2.jpg" alt="">
                           <div class="news-post-detail">
                              <!-- <span class="date">20 march 2016</span> -->
                              <h2><a href="blog-detail.html">Free play to ground in anywhere</a></h2>
                              <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
               ...
               <div class="col-md-3">
                  <div class="full">
                     <div class="contact-footer">
                        <iframe src="https://www.google.com/maps/place/United+Kingdom/@53.2202105,-22.2277193,4z/data=!3m1!4b1!4m5!3m4!1s0x25a3b1142c791a9:0xc4f8a0433288257a!8m2!3d55.378051!4d-3.435973" width="600" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
                     </div>
                  </div>
               </div>
            </div>
